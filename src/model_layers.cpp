...
auto conv3x3(int in_channels, int out_channels, int stride, int padding, bool bias) -> torch::nn::Conv2dOptions
{
...
auto ResidualHeadImpl::encoded_state_shape(ObservationShape observation_shape) -> ObservationShape
{
...
ResidualHeadDownsampleImpl::ResidualHeadDownsampleImpl(
    int input_channels,
    int output_channels,
...
auto ResidualHeadDownsampleImpl::encoded_state_shape(ObservationShape observation_shape) -> ObservationShape
{
